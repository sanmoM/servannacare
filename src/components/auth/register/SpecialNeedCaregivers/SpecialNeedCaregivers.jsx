      ...
      <div className={`w-full ${!started ? "my-0" : "my-12"} max-w-[700px] bg-white`}>
        {!started ? <SignUpStart onSuccess={handleSignupSuccess} /> : <>
            ...
            <div className="space-y-8 mt-6">
              {step === 1 && <SpecialNeedBasicInfo defaultValues={formData.basicInfo} onNext={handleNext} />}
              ...
              {step === 4 && <DocumentUploads defaultValues={formData.documents} onNext={handleNext} onBack={handleBack} />}
              {/* {step === 6 && (
                <ContactAgreement
              ...
              {step === 5 && <Review data={formData} onNext={handleNext} onBack={handleBack} />}
            </div>
          </>}
      </div>
    </div>;
