...
const CreateBasicInfo = ({
  ...
  const handleCreate = async e => {
    e.preventDefault();
    const requiredFields = ["companyName", "kraPin", "companyRegistrationNumber", "businessLocation", "phone", "registrationDocument"];
  ...
  return <form onSubmit={handleCreate} className="space-y-6">
