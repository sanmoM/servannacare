      ...
      <div className={`w-full ${!started ? "my-0" : "my-12"} max-w-[700px] bg-white`}>
        {!started ? <SignUpStart onSuccess={handleSignupSuccess} /> : <>
            ...
            <div className="space-y-8 mt-6">
              {step === 1 && <PhysiotherapistBasigInfo defaultValues={formData.basicInfo} onNext={handleNext} />}
              ...
              {step === 4 && <Document defaultValues={formData.documents} onNext={handleNext} onBack={handleBack} />}
