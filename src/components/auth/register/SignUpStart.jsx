...
const SignUpStart = ({
  ...
  const SPECIALIST_SUBROLE = ["house-manager", "nurse", "physiotherapist", "nurse-aide-or-assistant", "special-need-caregivers", "home-health-assistant", "home_health_assistant"];
