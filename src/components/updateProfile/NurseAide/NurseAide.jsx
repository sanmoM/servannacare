...
const NurseAideUpdate = ({
  ...
  const handleUpdate = async e => {
    ...
    const documentKeys = ["idCopy", "profilePhoto", "goodConductCertificate", "drivingLicense", "referenceLetter", "educationCertificate"];
      ...
      <form onSubmit={handleUpdate} className="space-y-6 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex-1">
            ...
            <div className="w-full mt-2">
              <PhoneInputWithCountrySelect className="w-full border rounded-md px-3 py-2" international defaultCountry={country} value={formData.basicInfo.number || "+254"} inputProps={{
              readOnly: true
            }} disabled />
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:gap-6 sm:gap-4">
          <div className="flex-1">
            ...
            <Input name="email" type="email" placeholder="housemanager@gmail.com" value={formData.basicInfo.email}
        ...
        {/* File Upload */}
        <div>
          <FileUpload title="Education Certificate (Compulsory)" accept="application/pdf,image/*" icon={<FileText size={32} />} optional="" file={eduIsImage ? eduFile : null} onFileSelect={file => handleFileSelect("documents", "educationCertificate", file)} />

          {eduFile && !eduIsImage && <FilePreview file={eduFile} alt="Education Certificate" />}
        </div>
