...
const MedicalInstitutionNurseAide = ({
  ...
  const handleSubmit = async e => {
    ...
    if (data.skills.length === 0) return toast.error("Select at least one service/skill");
    ...
    try {
      ...
      if (isUpdate) {
        ...
        toast.success("Nurse Aide updated successfully!", {
          id: loadingToast
        });
      } else {
        await postApi("/institution-nurse", payload);
        toast.success("Nurse Aide added successfully!", {
          id: loadingToast
        });
      }
      onSuccess?.(isUpdate);
      ...
      <form className="relative pb-16" onSubmit={handleSubmit}>
        ...
        <div className="my-6">
          ...
          education: val
            ...
            <div className="flex item-center gap-2">
              <RadioGroupItem className={"cursor-pointer"} value="other" id="d4" />
        ...
        <div className="pb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            return <div key={idx} className="flex items-center gap-2">
                  <Checkbox className="cursor-pointer" id={id} checked={data.languages.includes(lan.value)} onCheckedChange={() => toggleArray("languages", lan.value)} />
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            return <div key={idx} className="flex gap-2">
                  <Checkbox id={id} className="cursor-pointer" checked={data.skills.includes(skill)} onCheckedChange={() => toggleArray("skills", skill)} />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 pb-6">
            <Input label="Mobility Assistance (Years)" type="number" name="mobilityYears" value={data.mobilityYears} onChange={e => {
            handleChange({
              target: {
                name: "mobilityYears",
                value: numericInputFilter(e.target.value, 4)
            ...
            <Input label="Bathing Assistance (Years)" type="number" name="bathingYears" value={data.bathingYears} onChange={e => {
            handleChange({
              target: {
                name: "bathingYears",
                value: numericInputFilter(e.target.value, 4)
            ...
            <Input label="Feeding Assistance (Years)" type="number" name="feedingYears" value={data.feedingYears} onChange={e => {
            handleChange({
              target: {
                name: "feedingYears",
                value: numericInputFilter(e.target.value, 4)
