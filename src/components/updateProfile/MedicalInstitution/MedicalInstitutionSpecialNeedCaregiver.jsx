...
const MedicalInstitutionSpecialNeedCaregiver = ({
  ...
  const preferredInterventions = ["Autism Spectrum Disorder (ASD)", "Speech therapy", "ADHD (Attention Deficit Hyperactivity Disorder)", "Cerebral palsy", "Down syndrome", "Blindness", "Dementia & Alzheimer"];
  ...
  const handleSubmit = async e => {
    ...
    const loadingToast = toast.loading(isUpdate ? "Updating Caregiver..." : "Adding Caregiver...");
  ...
  return <div>
      <form className="relative pb-16" onSubmit={handleSubmit}>
        ...
        <div className="my-6">
          ...
          <RadioGroup className="flex flex-col flex-wrap gap-2 mt-2" value={data.education} onValueChange={value => setData(p => ({
          ...p,
          education: value
        }))}>
