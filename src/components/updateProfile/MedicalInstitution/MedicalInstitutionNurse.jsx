...
const MedicalInstitutionNurse = ({
  ...
  const servicesList = ["Basic Patient Care (bathing, dressing, feeding, and assisting with mobility)", "Vital Signs Monitoring (checking blood pressure, blood sugar, pulse, temperature, etc.)", "Medical Assistance: Assisting nurses with wound care and administering medication (in some cases)", "Compassion & Communication services", "Special needs children caregiving", "Elderly caregiving", "Handling Medical Equipment (e.g., feeding tubes, catheter, oxygen tanks)"];
  ...
  useEffect(() => {
    if (initialData && isUpdate) {
      ...
      setExistingFiles({
        ...
        practiceLicense: initialData.practiceLicense !== "null" ? initialData.practiceLicense : null
      });
      setReady(true);
    }
  ...
  const buildPayload = () => {
    ...
    Object.entries(data).forEach(([key, value]) => {
      ...
      if (["canDrive", "isNursingInKenya", "hospitalBasedCare", "homeBasedCare"].includes(key)) {
  ...
  const handleSubmit = async e => {
    ...
    if (data?.isNursingInKenya) {
      ...
      const hasExistingLicense = isUpdate && (existingFiles.practiceLicense || initialData?.practiceLicense);
      if (!data.practiceLicense && !hasExistingLicense) {
        toast.error("Practising Licence is Required");
        return;
      }
    }
    const loadingToast = toast.loading(isUpdate ? "Updating Nurse..." : "Adding Nurse...");
  ...
  return <div>
      <form className="relative pb-16" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col pb-6 md:flex-row md:gap-4 gap-6">
          <Input placeholder="Name" name="fullName" label="Full Name (as per ID)" value={data.fullName} onChange={handleChange} />

          <Input type="number" placeholder="Your age" name="age" label="Age" value={data.age} onChange={e => {
          handleChange({
            target: {
              name: "age",
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-4">
          <div className="flex-1">
            <Input label="Location" placeholder="Location" name="location" value={data.location} onChange={handleChange} />
          </div>
          ...
          <div className="flex-1">
            ...
            <Select value={data.experience} onValueChange={value => setData(prev => ({
            ...prev,
            experience: value
          }))}>
        ...
        <div className="mt-5">
          ...
          <div className="w-full mt-2">
            <PhoneInputWithCountrySelect className="w-full border rounded-md px-3 py-2" international defaultCountry={country} value={data?.number_two} onChange={value => {
            setData(prev => ({
              ...prev,
              number_two: value || ""
            }));
          ...
          {data?.number_two && !isValidPhoneNumber(data?.number_two) && <p className="text-red-500 text-sm mt-1">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-4 mt-4">
          <div className="flex-1">
            ...
            <RadioGroup value={data.gender} onValueChange={val => setData(p => ({
            ...p,
            gender: val
          }))} className="flex gap-4">
              <div className="flex items-center gap-2">
                <RadioGroupItem className="cursor-pointer" value="Male" id="g1" />
              ...
              <div className="flex items-center gap-2">
                <RadioGroupItem className="cursor-pointer" value="Female" id="g2" />
          ...
          <div className="flex-1">
            ...
            <RadioGroup value={data.canDrive === null ? "" : String(data.canDrive)} onValueChange={val => setData(p => ({
            ...p,
            canDrive: val === "true"
        ...
        <div className="flex flex-col mt-8 sm:flex-row gap-6 sm:gap-4 my-6">
          <div className="flex-1">
            ...
            <RadioGroup value={data.education} onValueChange={val => setData(p => ({
            ...p,
            education: val
          ...
          <div className="flex-1">
            ...
            <RadioGroup value={data.preferredRole} onValueChange={val => setData(p => ({
            ...p,
            preferredRole: val
          }))} className="flex gap-3">
              <div className="flex item-center gap-2">
                <RadioGroupItem className="cursor-pointer" value="Medical Nurse" id="r3" />
              ...
              <div className="flex item-center gap-2">
                <RadioGroupItem className="cursor-pointer" value="Nurse Aide" id="r4" />
        ...
        <div className="pb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            return <div key={idx} className="flex items-center gap-2">
                  <Checkbox id={id} className="cursor-pointer" checked={data.languages.includes(lan.value)} onCheckedChange={() => toggleArray("languages", lan.value)} />
        ...
        <FileUpload title="Education Certificate (Compulsory)" accept="application/pdf,image/*" icon={<FileText size={32} />} file={data.educationCertificate || existingFiles.educationCertificate} existingFile={existingFiles?.educationCertificate} onFileSelect={file => setData(p => ({
        ...p,
        ...
        <div className="py-4">
          ...
          <RadioGroup className="flex gap-3 mt-2" value={data.isNursingInKenya === null ? "" : String(data.isNursingInKenya)} onValueChange={val => {
          ...
          setData(prev => ({
            ...
            <div className="flex items-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="true" id="kenya1" />
              <Label className="cursor-pointer" htmlFor="kenya1">
                Yes
              </Label>
            </div>
            <div className="flex items-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="false" id="kenya2" />
          ...
          {data.isNursingInKenya && <div className="mt-4">
              <Input label={"Registration Number"} placeholder="Registration Number" type="number" value={data.registrationNumber || ""} onChange={e => setData(prev => ({
            ...prev,
            registrationNumber: e.target.value
          }))} />

              <div className="mt-6">
                <FileUpload title="Practising License" accept="application/pdf,image/*" icon={<FileText size={32} />} file={data?.practiceLicense || existingFiles?.practiceLicense} existingFile={existingFiles.practiceLicense} onFileSelect={file => setData(p => ({
              ...p,
        ...
        <div className="py-3">
          ...
          <RadioGroup value={data.hospitalBasedCare === null ? "" : String(data.hospitalBasedCare)} onValueChange={val => setData(prev => ({
          ...prev,
          hospitalBasedCare: val === "true"
        }))} className="flex gap-3">
            <div className="flex item-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="true" id="hb1" />
            ...
            <div className="flex item-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="false" id="hb2" />
          ...
          {data.hospitalBasedCare && <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Input type="number" label="Years of experience" value={data.hospitalBasedYearsOfExperience} onChange={e => setData(prev => ({
            ...prev,
            hospitalBasedYearsOfExperience: e.target.value
          }))} />
              <Input label="Reference contact" value={data.hospitalBasedReferenceContact} onChange={e => setData(prev => ({
            ...prev,
        ...
        <div className="py-3">
          ...
          <RadioGroup value={data.homeBasedCare === null ? "" : String(data.homeBasedCare)} onValueChange={val => setData(prev => ({
          ...prev,
          homeBasedCare: val === "true"
        }))} className="flex gap-3">
            <div className="flex item-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="true" id="hb3" />
            ...
            <div className="flex item-center gap-2">
              <RadioGroupItem className="cursor-pointer" value="false" id="hb4" />
          ...
          {data.homeBasedCare && <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Input type="number" label="Years of experience" value={data.homeBasedYearsOfExperience} onChange={e => setData(prev => ({
            ...prev,
            homeBasedYearsOfExperience: e.target.value
          }))} />
              <Input label="Reference contact" value={data.homeBasedReferenceContact} onChange={e => setData(prev => ({
            ...prev,
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            return <div key={idx} className="flex gap-2">
                  <Checkbox className="cursor-pointer" id={id} checked={data.services.includes(skill)} onCheckedChange={() => toggleArray("services", skill)} />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-4 pb-6">
            <Input label="Mobility Assistance (Years)" type="number" name="mobilityYears" value={data.mobilityYears}
          ...
          onChange={e => {
            ...
            <Input label="Bathing Assistance (Years)" type="number" name="bathingYears" value={data.bathingYears}
          //   onKeyDown={blockInvalidKeys}
          onChange={e => {
            handleChange({
              target: {
            ...
            <Input label="Feeding Assistance (Years)" type="number" name="feedingYears" value={data.feedingYears}
          //   onKeyDown={blockInvalidKeys}
          onChange={e => {
            handleChange({
              target: {
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          <Input label="Daily Rate (KSh)" placeholder="Daily Service Fee" name="serviceFeeDay" value={data.serviceFeeDay} onChange={e => {
          handleChange({
            target: {
              name: "serviceFeeDay",
              value: numericInputFilter(e.target.value, 4)
          ...
          <Input label="Monthly Rate (KSh)" placeholder="Monthly Service Fee" name="serviceFeeMonth" value={data.serviceFeeMonth} onChange={e => {
          handleChange({
            target: {
        ...
        {initialData && <>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <SelectableCalendar selectedDates={data.date || []} onChange={dates => setData(prev => ({
            ...prev,
            date: dates
          }))} disabled={date => {
