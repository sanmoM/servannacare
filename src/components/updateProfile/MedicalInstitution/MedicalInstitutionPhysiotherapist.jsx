    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (isUpdate) {
                ...
                toast.success("Physiotherapist updated successfully!", { id: loadingToast });
            } else {
                await postApi("/institution-nurse", payload);
                toast.success("Physiotherapist added successfully!", { id: loadingToast });
            }
    ...
    return (
        <div>
            <form className="relative pb-16" onSubmit={handleSubmit}>
                ...
                <h2 className="formHeading mt-8 pt-4 border-t">Education & Registration</h2>
                ...
                <div className="my-6">
                    ...
                    >
                        <RadioGroupItem value="Diploma In Physiotherapy" id="edu1" />
                        <Label htmlFor="edu1">Diploma In Physiotherapy</Label>

                        <RadioGroupItem value="Degree In Physiotherapy" id="edu2" />
                        <Label htmlFor="edu2">Degree In Physiotherapy</Label>
                    </RadioGroup>
                </div>
                ...
                <div className="py-4 mt-4">
                    ...
                    <RadioGroup
                        className="flex gap-4 mt-2"
                        value={
                            data.isRegisterPCK === null
                                ? ""
                                : String(data.isRegisterPCK)
                        }
                        onValueChange={(val) => {
