  ...
  return <div>
      <form onSubmit={handleUpdate} className="space-y-6 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          ...
          <div className="flex-1">
            <Input type="text" inputMode="numeric" placeholder="Your age" name="age" label="Age" value={formData.basicInfo?.age} onChange={e => {
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="w-full flex-1 flex flex-col">
            <Label>Are you a mother?</Label>
            <RadioGroup className="flex gap-4 mt-3" value={String(formData.additionalDetails.isMother)} onValueChange={v => handleAdditionalSelect("isMother", v)}>
              <div className="flex items-center gap-3">
        ...
        <div className="flex md:flex-row flex-col gap-6">
          ...
          // value={formData?.additionalDetails?.isHandelingPet}
          value={String(formData?.additionalDetails?.isHandelingPet)} onValueChange={v => handleAdditionalSelect("isHandelingPet", v)}>
              <div className="flex items-center gap-3">
        ...
        <div className="mt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            ...
            return <div key={doc.id} className="border rounded-xl p-4">
                  <FileUpload title={doc.title} accept="application/pdf,image/*" file={isImage ? file : null} onFileSelect={file => handleFileSelect(doc.id, file)} />
