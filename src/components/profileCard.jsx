...
import { Star, MapPin, Briefcase, GraduationCap, Mail, CheckCircle } from "lucide-react";
  ...
  <div className="relative z-10">
    <img
      ...
      onError={(e) => {
        ...
        e.target.src = `https://placehold.co/160x160/6366f1/white?text=${profile.name.charAt(0)}`;
      }}
    />
  </div>
</div>
      ...
      <div className="flex flex-col justify-between w-full lg:w-2/3 p-5">
        ...
        <div>
          <div className="flex items-start justify-between mb-3">
            <div>
              ...
              <p className="text-sm font-medium text-primary">{profile.category}</p>
            </div>
          ...
          <div className="space-y-2.5 mt-4">
            <InfoItem icon={Briefcase} label="Experience" value={`${profile.experience} years`} />
        ...
        <div className="flex gap-4 mt-5 pt-5 border-t border-gray-100">
          <div className="flex-1">           
             <Link href={`/profile?category=${profile.category.toLowerCase()}&id=${profile.id}`}>
