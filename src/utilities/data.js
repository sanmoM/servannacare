...
export const serviceCategory = [
  {
    ...
    value: "house-manager",
    preferredServices: ["Live In", "Dayburg"],
    preferredRoles: ["Nanny", "Housekeeper"],
    specializedServices: [
  ...
  },
  {
    ...
    preferredRoles: ["Medical Nurse", "Nurse Aide"],
    specializedServices: [
  ...
  },
  {
    ...
    preferredRoles: ["Special Need Caregiver"],
    specializedServices: [
      "Sensory Integration",
  ...
  },
  {
    ...
    preferredRoles: ["Home Health Assistant"],
    specializedServices: [
