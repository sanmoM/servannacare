...
const AgencySpecialistNotesPage = () => {
  const { user } = useAuth();
  ...
  const agencyEmployees = Array.isArray(profileData?.data?.agencyEmployees)
  ...
  const filteredSpecialists = agencyEmployees?.filter((s) =>
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      {view === "specialists" ? (
        <div className="space-y-6">
          ...
          {filteredSpecialists?.length > 0 ? (
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <span>Experience: {specialist.experience || "N/A"}</span>
                    </div>
                    <Button
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-dashed border-gray-200 shadow-sm">
              ...
              <p className="text-gray-500 mt-1">
                You do not have any employees listed yet.
              </p>
            </div>
          )}
        </div>
        ...
        <NodeChatArea
          ...
          chatAvatarText={(selectedSpecialist.name || "E").charAt(0)}
        />
      )}
    </div>
  );
...
export default AgencySpecialistNotesPage;
