...
const page = () => {
  ...
  return (
    <div>
      <div className="mb-10">
        <h1 className="sectionHeading">My Employee's Schedule</h1>
        <p className="mt-2 text-sm sm:text-base text-gray-600">Manage your employee's schedule efficiently</p>
      </div>
