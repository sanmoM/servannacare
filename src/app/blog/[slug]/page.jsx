      ...
      <Container className={"py-16"}>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-7">
          <div className="md:col-span-5">
            <h2 className="sectionHeading mb-6">{blog.title}</h2>
            <p className="text-gray-700 text-justify text-xs md:text-sm">
            ...
            <p className="text-gray-700 mt-3 text-justify text-xs md:text-sm">
              {blog.description}
            </p>
            ...
            <p className="text-gray-700 mt-6 text-justify text-xs md:text-sm">
